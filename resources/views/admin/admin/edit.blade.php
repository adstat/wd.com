		...
		<div class="layui-fluid">
			<div class="layui-row layui-col-space15">
                ...
                <p class="display conter " style="padding:10px;border-bottom: 1px solid #E9E9E9;><span class="tit_h ">编辑信息</span></p>
						<div>
							<form class="layui-form" action="{{url('admin/admin/save')}}">
								<div id="pub">
									<div>
										<p class="pub_p"><span><i class="color_red">*</i>员工姓名：</span><input type="text"  name="compellation" placeholder="" value="{{$data['compellation']}}"></p>

										<p class="pub_p"><span><i class="color_red">*</i>手机号：</span><input type="text" name="phone" placeholder="" value="{{$data['phone']}}"></p>

										<p class="pub_p"><span><i class="color_red">*</i>职位：</span><input type="text" name="job" placeholder="" value="{{$data['job']}}"> </p>

										<p class="pub_p"><span><i class="color_red">*</i>账号：</span><input type="text" disabled placeholder="" value="{{$data['admin_id']}}"> </p>
                                        <input type="hidden" name="admin_id" value="{{$data['admin_id']}}">
										<p class="pub_p"><span><i class="color_red">*</i>密码：</span><input type="text" name="password" placeholder="" value="{{$data['password']}}"> </p>
									</div>
