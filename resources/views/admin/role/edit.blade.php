		...
		<div class="layui-fluid">
			<div class="layui-row layui-col-space15">
                ...
                <p class="display conter " style="padding:10px;border-bottom: 1px solid #E9E9E9;><span class="tit_h ">编辑信息</span></p>
						<div>
							<form class="layui-form" action="{{url('admin/role/save')}}">
								<div id="pub">
									<div>
										<p class="pub_p"><span><i class="color_red">*</i>角色名称：</span><input type="text"  name="role_name" placeholder="" value="{{$data['role_name']}}"></p>
