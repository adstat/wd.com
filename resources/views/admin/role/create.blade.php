...
<html>
	...
	<body>
		...
		<div class="layui-fluid">
			<div class="layui-row layui-col-space15">
                ...
                <p class="display conter " style="padding:10px;border-bottom: 1px solid #E9E9E9";><span action="{{url('admin/admin/create')}}"  class="tit_h ">添加角色</span></p>
						<div>
							<form class="layui-form">
								<button type="button" id="createData"  class="bianji">保存</button>
								<div id="pub">
									<div>
										<p class="pub_p"><span><i class="color_red">*</i>角色名：</span><input type="text"  name="role_name" placeholder="" value=""></p>
									</div>
	...
	<script>
		$("#createData").on('click',function () {
            var url='{{url('admin/role/createRole')}}';
